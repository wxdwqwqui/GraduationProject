...
<a class="navbar-brand" href="${pageContext.request.contextPath}/">唯天下		</a>
</div>  
...
<li><a href="#">信息建立</a></li>  
<li><a href="${pageContext.request.contextPath}">信息查询</a></li>
<li><a href="${pageContext.request.contextPath}/course/video">信息管理</a></li>
<li class="divider"></li>  
